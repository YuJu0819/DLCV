...
epochs = 24
plot_epochs = {4 * i for i in range(1, 5)} | {1}
best_acc = 0.6
...
net = models.densenet161(weights=models.DenseNet161_Weights)
net = net.to(device)
net.train()
# loss_fn = SoftTargetCrossEntropy()
loss_fn = nn.CrossEntropyLoss()
optim = torch.optim.SGD(net.parameters(), lr=0.003)
scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optim, T_0 = 4, T_mult = 1)
mixup = Mixup(
    mixup_alpha=0.1,
    cutmix_alpha=1,
    cutmix_minmax=None,
