...
from p3_models import DomainClassifier, FeatureExtractor, LabelPredictor
...
if (device.type == 'cuda') and (ngpu > 1):
    ...
    L = nn.DataParallel(L, list(range(ngpu)))
...
scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optim, T_0 = 10, T_mult=1)
current_step = 0
